...
class AppRouter {
  static GoRouter router(AuthProvider auth) {
    return GoRouter(
      ...
      routes: [
        ...
        GoRoute(path: '/register/worker', builder: (_, __) => const WorkerRegistrationScreen()),
        GoRoute(path: '/register/contractor', builder: (_, __) => const ContractorRegistrationScreen()),
        GoRoute(path: '/register/company', builder: (_, __) => const CompanyRegistrationScreen()),

        // Company routes
        GoRoute(path: '/company/dashboard', builder: (_, __) => const CompanyDashboardScreen()),
        GoRoute(path: '/company/browse', builder: (_, __) => const BrowseScreen()),
        GoRoute(
          path: '/company/contractor/:id',
          builder: (_, state) => ContractorProfileScreen(contractorId: state.pathParameters['id']!),
        ),
        GoRoute(
          path: '/company/worker/:id',
          builder: (_, state) => WorkerProfileScreen(workerId: state.pathParameters['id']!),
        ),
        GoRoute(path: '/company/create-request', builder: (_, __) => const CreateHiringRequestScreen()),
        GoRoute(path: '/company/sent-requests', builder: (_, __) => const SentRequestsScreen()),

        // Contractor routes
        GoRoute(path: '/contractor/dashboard', builder: (_, __) => const ContractorDashboardScreen()),
        GoRoute(path: '/contractor/workers', builder: (_, __) => const ManageWorkersScreen()),
        GoRoute(path: '/contractor/add-worker', builder: (_, __) => const AddWorkerScreen()),
        GoRoute(path: '/contractor/requests', builder: (_, __) => const IncomingRequestsScreen()),

        // Worker routes
        GoRoute(path: '/worker/dashboard', builder: (_, __) => const WorkerDashboardScreen()),
        GoRoute(path: '/worker/profile', builder: (_, __) => const WorkerSelfProfileScreen()),
        GoRoute(path: '/worker/requests', builder: (_, __) => const WorkerRequestsScreen()),
  ...
  static UserRole _parseRole(String s) {
    switch (s) {
      case 'contractor': return UserRole.contractor;
